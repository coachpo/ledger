  ...
  return (
    <div className="max-w-5xl space-y-4 p-4">
      ...
      >
        <div className="flex min-w-0 flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0 space-y-3">
            ...
            <div className="min-w-0 space-y-1" data-testid="report-detail-identity">
              <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Immutable report snapshot</p>
              <div className="flex min-w-0 flex-wrap items-center gap-2">
                <h1 id="report-detail-title" className="break-words text-xl font-semibold tracking-tight">{report.name}</h1>
        ...
        <EvidenceCluster className="mt-3" items={reportEvidenceItems} layout="inline" />
      </section>
      ...
      >
        {isEditing ? (
          ...
          <div className="prose prose-sm dark:prose-invert max-w-none rounded-md border border-border bg-muted/30 px-6 py-4" data-testid="report-content-pane">
