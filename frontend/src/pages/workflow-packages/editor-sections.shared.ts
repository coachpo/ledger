import { Boxes, Braces, Cable, Code2, Download, KeyRound, ShieldCheck, Workflow } from "lucide-react";

import { diagnosticToEditorTarget, type WorkflowPackageEditorIssue } from "@/lib/platform-authoring/workflow-packages/manifest";
...
export function issueMessagesForPrefix(issues: readonly WorkflowPackageEditorIssue[], prefix: string) {
