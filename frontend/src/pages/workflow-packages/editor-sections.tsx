...
export function diagnosticToAuthoringTarget(path: string): Exclude<DiagnosticTarget, null> {
...
export function packageTitle(workflowPackage: WorkflowPackageRead | undefined, isNew: boolean) {
  return workflowPackage ? workflowPackage.name : isNew ? "New Workflow Package" : "Workflow Package";
}

export function packageSubtitle(workflowPackage: WorkflowPackageRead | undefined, isNew: boolean) {
  if (workflowPackage) {
...
export function connectionKindLabel(value: ModelConnectionKind | null | undefined): string {
...
export function ManifestBlockingState({ errors, loading, onRetry, title }: { errors: readonly string[]; loading: boolean; onRetry: () => void; title: string }) {
  return (
...
export function OverviewEditor({ draft, issues, isNew, onChange }: { draft: WorkflowPackageDraft; issues: readonly WorkflowPackageEditorIssue[]; isNew: boolean; onChange: (draft: WorkflowPackageDraft) => void }) {
...
export function OutputSchemasTab({ draft, issues, onChange }: { draft: WorkflowPackageDraft; issues: readonly WorkflowPackageEditorIssue[]; onChange: (draft: WorkflowPackageDraft) => void }) {
...
export function CapabilityProfilesTab(props: { draft: WorkflowPackageDraft; issues: readonly WorkflowPackageEditorIssue[]; onChange: (draft: WorkflowPackageDraft) => void; tools: { description: string; displayName: string; key: string }[]; toolsError: string | null; toolsLoading: boolean }) {
...
export function PrivateMcpTab({ draft, issues, onChange }: { draft: WorkflowPackageDraft; issues: readonly WorkflowPackageEditorIssue[]; onChange: (draft: WorkflowPackageDraft) => void }) {
...
export function WorkflowYamlTab({ draft, issues, onChange }: { draft: WorkflowPackageDraft; issues: readonly WorkflowPackageEditorIssue[]; onChange: (draft: WorkflowPackageDraft) => void }) {
