...
| Task                    | Location                                                                                                                                | Notes                                                                                                                           |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Portfolio inventory     | `list.tsx`                                                                                                                              | newest-updated ordering, modal create/edit, cards/table toggle, table-only batch selection/bulk delete, and delete confirmation |
...
- `list.tsx` owns route-level modal state, navigation, view mode, table-only selection state, and bulk delete; request/dialog policy stays in hooks and shared dialogs.
...
- Portfolio card/table navigation must remain explicit links. Cards are the default browse-only mode; table mode owns row checkboxes, select-all for shown rows, the bottom bulk-action bar, and clear selection. Create, edit, delete, trade, view switching, and dialog controls remain buttons or form controls.
