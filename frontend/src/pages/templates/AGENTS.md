...
- Template card/table navigation must stay as visible links. Formatting, preview, close, save, generate, delete, view switching, and runtime-input row actions remain buttons or form controls.
