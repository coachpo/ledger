...
| Hook test hotspots | `use-agents.test.ts`, `use-workflows.test.ts` | focused cache and mutation coverage |
...
- Agent-platform hooks follow the same split: cache policy and API wiring live here, while routed pages own draft UI, navigation, and feedback.
