...
| Agent-platform routes | `src/pages/workflow-packages/AGENTS.md`, `src/pages/scheduled-tasks/AGENTS.md`, `src/pages/model-connections/AGENTS.md`, `src/pages/memory/AGENTS.md`, `src/pages/runs/AGENTS.md` | Workflow Packages, Scheduled Tasks, Model Connections, Memory Admin, and Runs, including schedule fire history, trusted Memory Admin reads/writes, scoped runtime memory helpers, backend-owned run progress/queue payloads, and current rerun/fork readiness |
