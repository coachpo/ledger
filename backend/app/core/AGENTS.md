...
| Shared constants | `constants.py` | finance quote currency source and small shared constants |
...
- `constants.py` owns `PORTFOLIO_CURRENCY = "USD"` for finance quote currency checks.
