...
REPORT_MEMORY_WRITE_ACCESS_DENIED_CODE = FINANCE_WORKSPACE_DENIED_CODE
...
REPORT_MEMORY_WRITE_ACCESS_DENIED_MESSAGE = FINANCE_WORKSPACE_DENIED_MESSAGES[
    REPORT_MEMORY_WRITE_TOOL_KEY
]
...
REPORT_MEMORY_WRITE_GRANT_POLICY = RuntimeToolGrantPolicy(
