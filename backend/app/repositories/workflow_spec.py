...
class WorkflowSpecRepository(BaseRepository[WorkflowSpec]):
    model = WorkflowSpec
    ...
    def list_versions(self, key: str) -> list[WorkflowSpec]:
        statement = (
            select(self.model)
