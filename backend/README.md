...
RUNTIME_AGENT_MODEL=gpt-5.4-mini RUNTIME_AGENT_API_KEY="$OPENAI_API_KEY" RUNTIME_AGENT_BASE_URL=http://127.0.0.1:8080/v1 uv run uvicorn app.main:app --reload --port 28000
```
