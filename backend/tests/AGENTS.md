...
| Agent-platform run coverage | `test_workflow_package_runtime_api.py`, `test_workflow_package_run_contracts.py` | package execution, run detail/list, model-binding provenance, reruns, invocation-input forks, and legacy step replay read-lineage coverage |
