...
- `signaldeck.digital_oracle.macro_rates.lookup` is deferred and must not be exposed as a shipped runtime key without explicit contract approval for its key, schemas, warning semantics, and owner boundary.
