...
- Resolved admin entries can become runtime-visible only when future Workflow Package lookup matches their scope and grant rules. Pending and expired admin entries remain persisted and admin-visible without becoming default runtime lookup results.
