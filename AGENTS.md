...
- CI currently runs version-sync checks, backend lint/format/type/test checks, frontend lint/typecheck/build/test:run checks, then frontend E2E; Docker image publishing and cleanup live in separate workflows.
