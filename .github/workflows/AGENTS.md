...
## OVERVIEW
`.github/workflows/` owns repository automation for version sync, backend/frontend quality gates, browser E2E, and container image publishing. These workflows are operational guardrails for the current package-first platform and must stay aligned with the live backend/frontend toolchains and startup assumptions.
